# Regras de Extração e Janelas Temporais - Guia de Implementação: Integração de Sinais Vitais (iNNOVIAN -> SOARIAN) v1.0.0

* [**Table of Contents**](toc.md)
* **Regras de Extração e Janelas Temporais**

## Regras de Extração e Janelas Temporais

| | |
| :--- | :--- |
| *Official URL*:http://hospitaldaluz.pt/fhir/ig/vitalsigns/ImplementationGuide/innovian.to.soarian | *Version*:1.0.0 |
| Draft as of 2026-03-10 | *Computable Name*:IGiNNOVIANtoSOARIAN |
...
```json
{
  ...
  "id" : "innovian.to.soarian",
  "url" : "http://hospitaldaluz.pt/fhir/ig/vitalsigns/ImplementationGuide/innovian.to.soarian",
  "version" : "1.0.0",
  "name" : "IGiNNOVIANtoSOARIAN",
  "title" : "Guia de Implementação: Integração de Sinais Vitais (iNNOVIAN -> SOARIAN)",
  "status" : "draft",
  "date" : "2026-03-10T06:45:15+00:00",
  "publisher" : "Miguel Figueiredo",
  "packageId" : "innovian.to.soarian",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://hospitaldaluz.pt/fhir/ig/vitalsigns/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "Observation/ExampleHeartRatePreliminary"
      },
      "name" : "Exemplo de Frequência Cardíaca Preliminar",
      ...
      "exampleCanonical" : "http://hospitaldaluz.pt/fhir/ig/vitalsigns/StructureDefinition/sinais-vitais-innovian-base"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "OperationDefinition/vitals-snapshot"
      },
      "name" : "Operação - Extração de Snapshot de Sinais Vitais",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/sinais-vitais-innovian-base"
      },
      "name" : "Sinais Vitais Base - iNNOVIAN",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/codigos-vitais-innovian-vs"
      },
      "name" : "Value Set de Sinais Vitais do iNNOVIAN",
    ...
    "page" : {
      ...
      "page" : [{
        ...
        "nameUrl" : "index.html",
        "title" : "Regras de Extração e Janelas Temporais",
        "generation" : "markdown"
      }]
    },
    "parameter" : [{
